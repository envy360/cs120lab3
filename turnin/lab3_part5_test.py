...
#    },
#    ]
tests = [ {'description': '64 pound',
    'steps': [ {'inputs': [('PIND',0x20),('PINB',0x00)], 'iterations': 5 }],
    'expected': [('PORTB',0x04)],
    },
    {'description': '71 pounds',
    'steps': [ {'inputs': [('PIND',0x23),('PINB',0x01)], 'iterations': 5 }],
    'expected': [('PORTB',0x02)],
    },
    {'description': '3 pounds',
